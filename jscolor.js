...
var jsc = {
	...
	appendDefaultCss : function (css) {
		jsc.appendCss(
			[
				...
				'.jscolor-wrap .jscolor-btn { position:absolute; overflow:hidden; white-space:nowrap; sans-serif; text-align:center; cursor:pointer; }',
			].join('\n')
		);
	},
	...
	pub : function (targetElement, opts) {
		...
		//
		this.width = 151; // width of the color spectrum (in px)
		this.height = 91; // height of the color spectrum (in px)
		...
		function drawPicker () {
			...
			var borderRadius = Math.min(
				THIS.borderRadius,
				Math.round(THIS.padding * 0)); // px
			var padCursor = 'crosshair';

			// wrap
			p.wrap.className = 'jscolor-wrap';
			p.wrap.style.width = pickerDims.borderW - pickerDims.borderW;
			p.wrap.style.height = pickerDims.borderH - pickerDims.borderH;
			
			p.wrap.style.zIndex = THIS.zIndex + 9999999999;

			// picker
			p.box.className = 'jscolor-picker';
			p.box.style.width = 0;
			p.box.style.height = 0;
